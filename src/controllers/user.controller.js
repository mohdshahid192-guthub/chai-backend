...
try {
  ...
  throw new ApiError(400, "Can not generate refresh token");
...
const loginUser = asyncHandler(async (req, res) => {
  //get login details from user - email / username, password
  ...
  if (existUser.email === email || existUser.username === username) {
    const passwordIsCorrect = await existUser.isPasswordCorrect(password)
...
const changeCurrentUserPass = asyncHandler(async (req, res) => {
...
return res.status(200).json(new ApiResponse(200, {}, "password send successfully"))
